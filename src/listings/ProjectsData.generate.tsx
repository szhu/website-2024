...
BeNotified	benotified	Ready		https://github.com/szhu/BeNotified	2024/02/01	February 2024	Chrome Extension	BeReal desktop notifications.
git-uncommitted	git-uncommitted	Ready		https://github.com/szhu/git-uncommitted	2023/07/15	July 2023	Developer Tool	A simpler, per-branch alternative to git-stash that never causes merge conflicts.
ClipVideo	clipvideo	Ready	https://clip-video-szhu.vercel.app/	https://github.com/szhu/ClipVideo	2023/06/15	June 2023	Web App	Chop a long video any number of small pieces, adjacent or overlapping or not, extremely precisely. Works offline.
???	b	Ready			2023/05/16	June 2023–	Web App	????
...
Prep Panel	prep-panel	Ready		https://github.com/szhu/prep-panel	2022/07/26	July 2022	Developer Tool	Quickly batch apply preferences and run provisioning scripts, for onboarding and more.
...
Facebork	facebork	Defunct			2017/02/22	February 2017	Chrome Extension	Prevent distractions on Facebook by replacing every word with “bork”. (Unavailable due to trademark takedown.)
%%30%30	3030	Ready	https://szhu.github.io/3030/	https://github.com/szhu/3030	2015/09/20	September 2015	Web App	A unique 0-day game that exploited the “link that crashes Chrome” bug from 2015.
batchrename	batchrename	Ready		https://github.com/szhu/batchrename	2013/09/05	September 2013	Developer Tool	Batch-rename files from your text editor, so that you can take advantage of text-editing shortcuts you’re already familiar with.
S60 apps	s60	Defunct		https://github.com/szhu/s60-sandbox	2008/02/11	2006–2008	Other	A text editor, file browser, and some apps and explorations on the Symbian S60 mobile OS.
`;
